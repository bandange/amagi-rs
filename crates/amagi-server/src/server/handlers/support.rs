...
use super::{ApiSpecErrorResponse, FetchErrorResponse};
use amagi_adapters::bilibili::BilibiliFetcher;
use amagi_adapters::douyin::DouyinFetcher;
use amagi_adapters::kuaishou::KuaishouFetcher;
use amagi_adapters::twitter::TwitterFetcher;
use amagi_adapters::xiaohongshu::XiaohongshuFetcher;
use amagi_core::AppError;
use amagi_core::Platform;

pub(super) type ApiSpecResult<T> = Result<Json<T>, (StatusCode, Json<ApiSpecErrorResponse>)>;
