...
use amagi_client::{AdapterContext, AmagiClient, CookieConfig};
...
pub struct AppState {
    ...
    /// Shared SDK-style client carrying API metadata and request defaults.
...
impl AppState {
    ...
    pub fn platform_client(&self, platform: Platform) -> AdapterContext {
